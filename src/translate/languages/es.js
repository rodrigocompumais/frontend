    ...
    translations: {
      ...
      userModal: {
        ...
        pageAccess: {
          ...
          pages: {
            tickets: "Atenciones",
            "tickets-finalizadas": "Conversaciones finalizadas",
            dashboard: "Dashboard",
            kanban: "Kanban",
            chats: "Chat interno",
            "quick-messages": "Respuestas rápidas",
            todolist: "Tareas",
            ...
            flowbuilders: "Flujos",
            flowbuilder: "Editor de flujo",
            "phrase-lists": "Frases de campaña",
            "campaigns-config": "Config. de campañas",
            prompts: "Prompts de IA",
            users: "Usuarios",
            connections: "Conexiones",
            queues: "Filas",
            files: "Archivos",
            "queue-integration": "Integraciones de fila",
            "messages-api": "API de mensajes",
            financeiro: "Financiero",
            announcements: "Informativos",
            helps: "Ayuda",
            "help-articles": "Artículos de ayuda",
            settings: "Configuración",
            "quick-access-buttons-settings": "Botones de acceso rápido",
      ...
      ticketsHistory: {
        readOnlyBanner: "Atención cerrada — solo lectura",
        readOnlyTitle: "Solo lectura",
        readOnlyDesc: "Esta atención ya está cerrada. Puede leer los mensajes, pero no enviar nuevos.",
        searchPlaceholder: "Escriba nombre o teléfono del cliente",
        searchLabel: "Buscar cliente",
        dateFrom: "Fecha inicial",
        dateTo: "Fecha final",
        dateFilterHint: "Opcional: filtrar por fecha de cierre de la atención",
        contactsCount: "clientes con conversaciones cerradas",
        session: "atención cerrada",
        sessions: "atenciones cerradas",
        empty: "No se encontró ningún cliente. Pruebe otro nombre o quite los filtros.",
        loadMore: "Ver más clientes",
        welcomeTitle: "Cómo consultar conversaciones cerradas",
        welcomeSubtitle: "Siga los pasos. Aquí solo puede leer — no enviar mensajes.",
        welcomeStep1: "Elija un cliente en la lista al lado",
        welcomeStep2: "Elija una atención o vea todos los mensajes juntos",
        welcomeStep3: "Lea el historial completo de la conversación",
        noSessions: "Este cliente no tiene atenciones cerradas para mostrar.",
        noMessages: "No hay mensajes para mostrar en este período.",
        pageSubtitle: "Consulte conversaciones ya cerradas. Solo lectura.",
        step1Label: "Paso 1 de 3",
        step1Hint: "Toque el nombre de un cliente",
        step2Label: "Paso 2 de 3",
        step2Hint: "Elija cómo ver el historial",
        step3Label: "Paso 3 de 3",
        step3Hint: "Lea los mensajes de la conversación",
        filtersShow: "Mostrar filtros (opcional)",
        filtersHide: "Ocultar filtros",
        filterWhatsappLabel: "Conexión WhatsApp",
        filterWhatsappHint: "Toque para filtrar por una o más conexiones",
        backToList: "Volver a la lista de clientes",
        backToSessions: "Volver a las atenciones de este cliente",
        viewConversation: "Ver conversación",
        tapToOpen: "Toque para abrir",
        sessionsTabTitle: "Una atención a la vez",
        sessionsTabDesc: "Cada conversación cerrada por separado",
        timelineTabTitle: "Todos los mensajes juntos",
        timelineTabDesc: "Mensajes en orden de fecha de todas las atenciones",
        sessionEnded: "Cerrado el",
        attendedBy: "Atendido por",
        connection: "WhatsApp usado",
        timelineScrollHint: "Desplace hacia arriba para ver mensajes más antiguos",
        timelineBlockLabel: "Inicio de la atención",
        listaClientes: "Clientes",
        messageFromCompany: "Su empresa",
        messageFromClient: "Cliente",
        reopenConversation: "Reabrir conversación",
        reopenSuccess: "Conversación reabierta. Redirigiendo a Atenciones…",
        reopenHint: "Podrá enviar mensajes de nuevo en la pantalla principal de atenciones.",
      },
      transferTicketModal: {
      ...
      announcements: {
        ...
        medium: "Media",
        low: "Baja",
        empty: "Ningún informativo activo",
        loginPopup: {
      ...
      settings: {
        ...
        options: {
          ...
          fields: {
            ...
            limitConnectionGreeting: {
              title: "Limitar saludo de la conexión",
              description:
                "Envía como máximo un saludo por interacción (ventana de 24h) o al reabrir un chat cerrado",
            },
            lmStudioInfra: {
        ...
        company: {
          toasts: {
            errorList: "No se pudo cargar la lista de registros",
            errorOperation: "No se pudo realizar la operación",
            error:
              "No se pudo realizar la operación. Verifique si ya existe una empresa con el mismo nombre o si los campos están completos",
            success: "¡Operación realizada con éxito!",
            reactivated: "¡Empresa reactivada con éxito!",
          },
          confirmModal: {
          ...
          modal: {
            ...
            inactiveTitle: "Empresas inactivas",
          },
          searchPlaceholder: "Buscar empresas activas...",
          searchInactivePlaceholder: "Buscar empresas inactivas...",
          inactiveHint: "Haga clic en el icono verde para reactivar la empresa.",
      ...
      backendErrors: {
        ...
        ERR_MESA_QR_INVALID:
          "Código QR inválido. Escanee el QR impreso en la mesa o comanda, o pegue el enlace completo.",
        ERR_MESA_QR_TOKEN_INVALID:
          "Este código QR no pertenece a su empresa o está dañado.",
        ERR_MESA_QR_ID_UNAVAILABLE:
          "Este identificador del QR ya está en uso por otra empresa y no puede restaurarse.",
        ERR_MESA_RESTORE_ALREADY_EXISTS:
          "Esta mesa o comanda ya está registrada. No es necesario restaurar.",
        ERR_MESA_NUMBER_ALREADY_EXISTS:
          "Ya existe una mesa o comanda con este número. Elija otro número.",
        ERR_USER_INACTIVE:
