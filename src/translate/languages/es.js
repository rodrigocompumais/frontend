    ...
    translations: {
      ...
      settings: {
        ...
        optionsPix: {
          ...
          receiverCity: "Ciudad del receptor",
          save: "Guardar",
          saving: "Guardando...",
          toastSuccess: "Configuración de cobro PIX guardada.",
        ...
        options: {
          ...
          fields: {
            ...
            aiProviderConfig: {
              ...
              helper: "Cuando ambas claves estén configuradas, puede elegir qué proveedor usar para cada función.",
              summaries: "Resúmenes",
              ...
              compuchat: "COMPUCHAT (Tablero)",
              compuchatHelper: "Proveedor para el chat inteligente del tablero",
              translation: "Traducción de Mensajes",
              translationHelper: "Proveedor para la traducción automática de mensajes",
            },
            chatConfig: {
              title: "Configuración de Chat IA (Compuchat)",
              helper: "Configure la temperatura, longitud del contexto y otros parámetros para el chat inteligente del tablero.",
              temperature: "Temperatura",
              temperatureHelper: "Controla la creatividad (0.0-2.0). Valores más bajos = más enfocado, más altos = más creativo.",
              maxHistoryMessages: "Historial de Mensajes",
              maxHistoryMessagesHelper: "Cantidad de mensajes anteriores a considerar (0-100).",
              maxTokens: "Máximo de Tokens",
              maxTokensHelper: "Límite máximo de tokens en la respuesta (100-32000).",
              topP: "Top P",
              topPHelper: "Muestreo de núcleo (0.0-1.0). Controla la diversidad de respuestas.",
            ...
            apiCredentials: {
              ...
              helper: "Use estas credenciales para integraciones y APIs externas. Haga clic en el icono para copiar.",
              companyId: "ID de la Empresa",
              jwtToken: "Token JWT",
              tokenHelper: "Haga clic en el campo para mostrar/ocultar el token. Use en el header Authorization: Bearer {token}",
              copy: "Copiar",
              copied: "{{label}} copiado al portapapeles!",
              copyError: "No se pudo copiar.",
            },
            printDevices: {
              title: "Dispositivos de Impresión",
              helper: "Administre los dispositivos que reciben trabajos de impresión por WebSocket. Use token y device_id en el Print Agent.",
              add: "Agregar dispositivo",
              addTitle: "Nuevo dispositivo de impresión",
              name: "Nombre",
              deviceId: "Device ID",
              token: "Token",
              actions: "Acciones",
              empty: "Ningún dispositivo configurado. Agregue uno para conectar el Print Agent.",
              deviceIdRequired: "Device ID es obligatorio.",
              namePlaceholder: "ej: Impresora de Cocina",
              create: "Crear",
              cancel: "Cancelar",
              created: "Dispositivo creado correctamente! Copie el token y configure el Print Agent.",
              deleted: "Dispositivo eliminado.",
              tokenRegenerated: "Token regenerado. Actualice la configuración del Print Agent.",
              regenerateToken: "Generar nuevo token",
              delete: "Eliminar",
              confirmDelete: "¿Está seguro de que desea eliminar este dispositivo?",
            },
            apiKeys: {
              testButton: "Probar Clave",
              testing: "Probando...",
              testGeminiError: "Por favor, ingrese una clave API de Gemini antes de probar.",
              testOpenaiError: "Por favor, ingrese una clave API de OpenAI antes de probar.",
              testSuccess: "¡Clave API válida y funcionando!",
              testError: "Clave API inválida.",
              testApiError: "Error al probar la clave API",
              configUpdated: "¡Configuración del proveedor actualizada!",
              configError: "Error al actualizar la configuración",
              providersError: "Error al cargar las configuraciones del proveedor",
            },
            companyLanguage: {
              title: "Idioma de la Empresa",
              helper: "Seleccione el idioma preferido para los tickets. Los mensajes en otros idiomas se traducirán automáticamente.",
      ...
      backendErrors: {
        ...
        ERR_TICKET_CLOSED_CANNOT_SEND:
          "Esta conversación está cerrada. Vuelva a abrir el ticket para enviar mensajes al cliente.",
      ...
      lanchonetes: {
        ...
        variablePriceHelp: "Al añadir en pedidos (Mesas/Camarero), se solicitará el valor (ej.: comida por kg). El valor anterior sirve como sugerencia.",
        unitValueLabel: "Valor unitario (R$)",
        unitValueDialogTitle: "Valor unitario",
        unitValueDialogHelp: "Indique cantidad y valor unitario (ej.: comida por kg).",
      ...
      mesas: {
        ...
        valuePerPerson: "Valor por persona",
        ...
        paymentPixTitle: "Pago por PIX",
        copyPixCode: "Copiar código PIX",
        pixCodeCopied: "¡Código PIX copiado!",
        closeAndLiberate: "Cerrar cuenta y liberar",
        cancel: "Cancelar",
        noOrders: "Ningún pedido en esta sesión.",
        ordersTitle: "Pedidos de la mesa",
        total: "Total",
        tableLiberated: "Mesa liberada",
        configurePixKey: "Configure una clave PIX en configuración (Cobro PIX) para generar el código QR.",
      },
      forms: {
        title: "Formulários",
