    ...
    translations: {
      ...
      settings: {
        ...
        optionsPix: {
          ...
          receiverCity: "Cidade do recebedor",
          save: "Salvar",
          saving: "Salvando...",
          toastSuccess: "Configurações de cobrança PIX salvas.",
        ...
        options: {
          ...
          fields: {
            ...
            chatConfig: {
              title: "Configurações do Chat IA (Compuchat)",
              helper: "Configure a temperatura, quantidade de contexto e outros parâmetros do chat inteligente do dashboard.",
              temperature: "Temperatura",
              temperatureHelper: "Controla a criatividade (0.0-2.0). Valores menores = mais focado, maiores = mais criativo.",
              maxHistoryMessages: "Histórico de Mensagens",
              maxHistoryMessagesHelper: "Quantidade de mensagens anteriores a considerar (0-100).",
              maxTokens: "Máximo de Tokens",
              maxTokensHelper: "Limite máximo de tokens na resposta (100-32000).",
              topP: "Top P",
              topPHelper: "Nucleus sampling (0.0-1.0). Controla diversidade das respostas.",
            ...
            apiKeys: {
              ...
              testing: "Testando...",
              testGeminiError: "Por favor, insira uma chave da API do Gemini antes de testar.",
              testOpenaiError: "Por favor, insira uma chave da API do OpenAI antes de testar.",
              testSuccess: "Chave da API válida e funcionando!",
              testError: "Chave da API inválida.",
              testApiError: "Erro ao testar chave da API",
              configUpdated: "Configuração de provider atualizada!",
              configError: "Erro ao atualizar configuração",
              providersError: "Erro ao carregar configurações de providers",
            },
            asaas: {
              tab: "ASAAS",
      ...
      messagesList: {
        ...
        transcriptionModal: {
          ...
          loading: "Processando áudio...",
          loadingHint: "Isso pode levar alguns segundos",
          errorTitle: "Não foi possível transcrever",
      ...
      messagesInput: {
        mention: "Mencionar participante",
      ...
      lanchonetes: {
        hubName: "Home",
        hubWelcome: "Bem-vindo ao Home",
        hubWelcomeSubtitle: "Use as abas acima para gerenciar produtos, cardápio, mesas e pedidos. Tudo em um só lugar.",
        cardapiosSection: "Cardápios",
        cardapiosDescription: "Seus cardápios para os clientes fazerem pedidos. Copie o link ou edite o cardápio.",
        cardapiosEmpty: "Nenhum cardápio cadastrado. Crie um em Cardápios.",
      ...
      mesas: {
        ...
        paymentPixTitle: "Pagamento por PIX",
        copyPixCode: "Copiar código PIX",
        pixCodeCopied: "Código PIX copiado!",
        closeAndLiberate: "Fechar conta e liberar",
        cancel: "Cancelar",
        noOrders: "Nenhum pedido nesta sessão.",
        ordersTitle: "Pedidos da mesa",
        total: "Total",
